...
public class GUIProducts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(pnlSouth, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 360, 595, -1));
        ...
        getContentPane().add(pnlCenter, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 595, 249));

        jLabelCategoryName.setText("Categoria:");
        getContentPane().add(jLabelCategoryName, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 300, -1, -1));

        getContentPane().add(jComboBoxCategory, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 290, 290, 40));
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        if (!categories.isEmpty()) {
            ...
            addOption = true;
            update_cmbCategories(categories);
        } else {
            Messages.showMessageDialog("No hay categorias", "ALERTA");
        }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (jComboBoxCategory.getSelectedIndex() == 0) {
            Messages.showMessageDialog("Seleccione una categorias", "Hola");
            return;
        }
        if (addOption) {
            //Agregar
    ...
    private void txtIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtIdFocusLost
        ...
        if (prod == null) {
            ...
            jComboBoxCategory.setSelectedIndex(prod.getCategory().getCategoryId().intValue());
        }
    ...
    private void addProduct() {
        ...
        if (productService.saveProduct(name, description, findCategoryByIndex(Long.valueOf((long) jComboBoxCategory.getSelectedIndex())))) {
    ...
    private void editProduct() {
        ...
        prod.setCategory(findCategoryByIndex(Long.valueOf(jComboBoxCategory.getSelectedIndex())));
    ...
    public Category findCategoryByIndex(Long selectedIndex) {
